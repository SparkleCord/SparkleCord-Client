...
function sendSystemMessage({ content = "", embeds = [], type = "core", ephemeral = false } = {}) {
    try {
        ...
        const nameColor = systemUsers[type].color || DEFAULT_COLOR;
        ...
        const botTag = `<span class="botTag" style="background: ${tagColor};">${systemUsers[type].tag?.verified ? verified : ``} <span class="text">${systemUsers[type].tag?.name || "Bot"}</span></span>`;
        ...
        messageElement.setAttribute("data-botTag", botTag);
        ...
        messageElement.innerHTML = isGrouped ?
            ...
            <div class="message-background">
                <div class="message-content">
                    <div class="author">
                        <span class="name" style="color: ${data.color}">${systemUsers[type].name}</span>
                        ${botTag}<span class="timestamp">${formatTimestamp(timestamp)}</span>
                    </div>
                  ${messageHTML}
                  ${isEphemeral ? eph : ""}
                </div>
