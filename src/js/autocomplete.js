class AutoComplete {
    ...
    appendSuggestion(item, type, isSelected) {
        ...
        const div = Object.assign(document.createElement("div"), { 
            ...
            innerHTML: `
                <span>${type === "emoji" ? `${this.emojiUtils.getEmojiByName(item)} :${item}:` : item}</span>
    ...
    onKeyDown(event) {
        // this.suggestionsDiv.classList.contains("show") ||
        if (!this.shouldAutoselect() || !this.suggestionsDiv.classList.contains("show")) return;
        const items = this.suggestionsDiv.querySelectorAll(".suggestion-item");
