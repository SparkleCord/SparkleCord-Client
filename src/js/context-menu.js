...
class MessageActivities {
    ...
    init() {
        ...
        document.addEventListener("keydown", (e) => {
            ...
            if (e.key === KEYBIND_EDIT) { e.preventDefault(); this.editMessage([...document.querySelectorAll("#messages .message[data-userid='" + profile.id + "']")].at(-1)) }
        })
    }
    // Operation Functions
    deleteMessage(msg) {
    ...
    editMessage(msg) {
        ...
        const saveEdit = () => {
            ...
            hasMentions = mentionPattern.test(newText);
