class MessageActivities {
    ...
    editMessage(msg) {
        ...
        // create the box
        const container = createElement("div", { className: "edit-container" });
        const input = createElement("textarea", { id: "edit-box", value: content.replace(/^@g/, "") });
        const cancelButton = createElement("a", { className: "link", role: "button", textContent: "cancel" });
        const saveButton = createElement("a", { className: "link", role: "button", textContent: "save" });     
        const editOps = createElement("div", { 
        ...
        function saveEdit() {
            ...
            if (content !== newTextTemp) {
                const tag = createElement("span", { className: "edited-tag", textContent: " (edited)", title: formatTime(Date.now(), "F") });
